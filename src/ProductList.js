...
class ProductList extends React.Component
{
    constructor(props)
    {
        ...
        productList.push(new Product("Pression Orge bio 25cl", 3));
        productList.push(new Product("Pression Orge bio 50cl", 5.5));
        productList.push(new Product("Pression Titan IPA 25cl", 3.5));
        productList.push(new Product("Pression Titan IPA 50cl", 6));
        ...
        productList.push(new Product("Jus de fruit 25cl", 2));
